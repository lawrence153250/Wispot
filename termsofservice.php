...
<div class="tos-container">
    ...
    <div class="tos-section">
        <h2><i class="bi bi-info-circle"></i><b>INTRODUCTION</b></h2>
        <p>Welcome to our Starlink Rental Services! These terms govern your use of our satellite internet rental platform and equipment.</p>
    </div>
    
    <div class="tos-section">
        <h2><i class="bi bi-shield-lock"></i><b>LICENSE</b></h2>
        <p>All Starlink equipment and related technology remains property of our company. You're granted temporary access to the hardware and service for the duration of your rental period only.</p>
    </div>
    
    <div class="tos-section">
        <h2><i class="bi bi-chat-square-text"></i><b>USER RESPONSIBILITIES</b></h2>
        <p>As a renter, you agree to use the Starlink equipment properly, maintain it in good condition, and report any issues immediately. Any damage due to negligence may result in additional charges.</p>
    </div>
    
    <div class="tos-section tos-contact">
        <h2><i class="bi bi-headset"></i><b>CONTACT US</b></h2>
        <p>Need help with your Starlink rental?</p>
